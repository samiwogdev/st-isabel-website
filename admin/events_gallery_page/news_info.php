    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><small>Add new News Information</small></h2>
                    ...
                    <div class="x_content">
                        <br />
                        <form class="form-horizontal form-label-left" action="../controller/add_news_data" method="post" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <button type="submit" name="add_news_data" class="btn btn-success">Submit</button>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $news_data = News::getInstance();
                                            $count = 1;
                                            $result = $news_data->getAll();
                                              if ($result){
