...
<!--                            <li><a class="close-link"><i class="fa fa-close"></i></a>-->
                    ...
                    <div class="x_content">
                        <br />
                        <form class="form-horizontal form-label-left" action="../controller/add_gallery_definition.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <button type="submit" name="add_gallery_definition" class="btn btn-success">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
                                ...
                                <div class="card-box table-responsive">
                                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            $count = 1;
                                            $rows = $gallery_definition->getAll();
                                            foreach ($rows as $row) {
                                                ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-center">
                                                            <a href="gallery_picture.php?auth=<?php echo $row['id'] ?>"><span class="fa fa-plus text-primary fa-2x mr-2" style="cursor: pointer" title="add Gallery Picture"></span></a>
