...
<!--                            <li><a class="close-link"><i class="fa fa-close"></i></a>-->
                    ...
                    <div class="x_content">
                        <br />
                        <form class="form-horizontal form-label-left" action="../controller/add_news_banner.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <div class="form-group">
                                        <input type="file" class="form-control-file" name="news_image" id="exampleFormControlFile1">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <button type="submit" name="add_news_banner" class="btn btn-success">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
