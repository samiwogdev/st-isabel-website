            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        ?>
                        <form class="form-horizontal form-label-left" action="../controller/update_admission_info_page?auth=<?php echo $auths ?>" method="post" enctype="multipart/form-data">

                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Title <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" name="title" value="<?php echo $admission_info_pageInfo['title'] ?>" required="required" class="form-control ">
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <button type="submit" name="update_admission_info_page" class="btn btn-success">Update</button>
                                </div>
                            </div>
                        </form>
                    </div>
