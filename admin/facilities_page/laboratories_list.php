            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" action="../controller/add_laboratories_list.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <button type="submit" name="add_laboratories_list" class="btn btn-success">Submit</button>
                                </div>
                            </div>
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $count = 1;
                                                $laboratories_listInfos = $laboratories_list->getAll();
                                                foreach ($laboratories_listInfos as $laboratories_listInfo){ 
                                            ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="../controller/delete_laboratories_list?auth=<?php echo $laboratories_listInfo['id']?>"> <span class="fa fa-trash text-danger fa-2x" style="cursor: pointer"></span></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <?php } ?>
