            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" action="../controller/add_library_info_page.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <button type="submit" name="add_library_info_page" class="btn btn-success">Submit</button>
                                </div>
                            </div>
