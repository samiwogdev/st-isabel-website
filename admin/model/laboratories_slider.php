...
class Laboratories_slider extends Connection {
    private $id;
    private $title;
    private $slider_image;
    private $table_name ="laboratories_slider";
    private static $instance;

    public static function getInstance() {
        if (!isset(self::$instance) || is_null(self::$instance)) {
            try {
                self::$instance = new Laboratories_slider();
            } catch (Exception $ex) {
    ...
    public function add() {
        $sql = "INSERT INTO " . $this->table_name . " (title, slider_image) VALUES(:title, :slider_image)";
    ...
    public function update() {
        $sql = "UPDATE " . $this->table_name . " SET title = :title, slider_image = :slider_image  WHERE id = :id";
        $statement = $this->getDbConnection()->prepare($sql);
