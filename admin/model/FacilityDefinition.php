...
/**
 * Description of FacilityDefinition
 *
 * @author samiwog
 */
class FacilityDefinition extends Connection {

    private $id;
    private $title;
    private $table_name = "facility_definition";
    ...
    public static function getInstance() {
        if (!isset(self::$instance) || is_null(self::$instance)) {
            try {
                self::$instance = new FacilityDefinition();
            } catch (Exception $ex) {
