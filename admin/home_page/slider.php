        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form class="form-horizontal form-label-left" action="../controller/add_slider.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <button type="submit" name="add_slider" class="btn btn-success">Submit</button>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($sliderInfos as $sliderInfo) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $sliderInfo['title'] ?></td>
                                                    <td><?php echo $sliderInfo['description'] ?></td>
                                                    <td class="text-center"><img src="../uploads/raw/<?php echo $sliderInfo['slider_image'] ?>" width="30px"></td>
                                                    <td>
