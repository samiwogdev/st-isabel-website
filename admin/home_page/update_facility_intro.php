    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><small>Update Facility Intro Information</small></h2>
                    ...
                    <div class="x_content">
                        ...
                        $auths = FacilityIntro::sanitize_input($auth);
                        $page_info->setId($auths);
                        $page_infoInfo = $page_info->getById();
                        ?>
                        <form class="form-horizontal form-label-left" action="../controller/update_facility_intro?auth=<?php echo $auths ?>" method="post" enctype="multipart/form-data">
