    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><small>Add new Facility intro</small></h2>
...
<!--                            <li><a class="close-link"><i class="fa fa-close"></i></a>-->
                    ...
                    <div class="x_content">
                        <br />
                        <form class="form-horizontal form-label-left" action="../controller/add_facility_intro.php"  method="post" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <button type="submit" name="add_facility_intro" class="btn btn-success">Submit</button>
                                </div>
                            </div>
