            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>ST Isabel</span></a>
                    </div>
                    ...
                    <div class="profile clearfix">
                        <div class="profile_pic">
                            <img src="admin-assets/images/nopic.jpg" alt="..." class="img-circle profile_img">
                        </div>
                            ...
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        ...
                                        <li><a href="slider">Slider Ext</a></li>
                                        <li><a href="slider">School Qualities</a></li>
                                        <li><a href="slider">Enrolment Info</a></li>
                                        <li><a href="slider">School Song</a></li>
                                    </ul>
                                </li>
