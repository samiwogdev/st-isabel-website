...
<!--                            <li><a class="close-link"><i class="fa fa-close"></i></a>-->
                    ...
                    <div class="x_content">
                        <br />
                        <form class="form-horizontal form-label-left" action="../controller/add_banner.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-box table-responsive">
                                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <?php
                                                ...
                                                $count = 1;
                                                $bannerInfos = $banner->getAll();
                                                foreach ($bannerInfos as $bannerInfo){ 
                                        ?>
                                            <tr>
                                                <td><?php echo $count ?></td>
                                                <td><?php echo $bannerInfo['title'] ?></td>
                                                <td class="text-center"><img src="../admin-assets/images/media.jpg<?php echo $bannerInfo['banner_image'] ?>" width="30px"></td>
                                                <td>
                                                    <div class="text-center">
                                                    <a href="update_banner?auth=<?php echo $bannerInfo['id'] ?>"><span class="fa fa-edit text-primary fa-2x" style="cursor: pointer"></span></a>
                                                    <a href="../controller/delete_banner?auth=<?php echo $bannerInfo['id'] ?>"><span class="fa fa-trash text-danger fa-2x" style="cursor: pointer"></span></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <?php } ?>
