                             ...
                             <div class="course-feature">
                                <div class="feature-main">
                                    ...
                                    <div class="single-feature">
                                        ...
                                        <span class="label">Shelves are easy to reach</span>
                                        <span class="value"></span>
                                    </div>
                                    <!--/ End Single Feature -->
                                    <!-- Single Feature -->
                                    <div class="single-feature">
                                        ...
                                        <span class="label"> Flexible reading area</span>
                                        <span class="value"></span>
                                    </div>
                                    <!--/ End Single Feature -->
                                    <!-- Single Feature -->
                                    <div class="single-feature">
                                        ...
                                        <span class="label">Distinct zones for different uses</span>
                                        <span class="value"></span>
                                    </div>
                                    <!--/ End Single Feature -->
                                    <!-- Single Feature -->
                                    <div class="single-feature">
                                        ...
                                        <span class="label">Lots of comfortable furniture</span>
                                        <span class="value"></span>
                                    </div>
                                    <!--/ End Single Feature -->
                                    <!-- Single Feature -->
                                    <div class="single-feature">
                                        ...
                                        <span class="label">Wireless connectivity and Computers</span>
                                        <span class="value"></span>
                                    </div>
                                    <!--/ End Single Feature -->
                                    <!-- Single Feature -->
                                    <div class="single-feature">
                                        <i class="fa fa-check-square-o"></i>
                                        <span class="label">Full of natural light</span>
                                        <span class="value"></span>
                                    </div>
